    ...
    <div className="App">
      <Layout>
        ...
        <Layout>
          <Sider>
            <Menu
              defaultSelectedKeys={['Nos services']}
              mode="inline"
            >
  ...
  <div className="row">
    <div className="col-sm-12">
      ...
      <form>
        ...
        <div className="radio">
          <label>
            <input type="radio" value="beaute" />
            Beauté
          </label>
        </div>
        <div className="radio">
          <label>
            <input type="radio" value="electronique" />
            Electronique
          </label>
        </div>
        <div className="radio">
          <label>
            <input type="radio" value="informatique" />
            Informatique
          </label>
        </div>
        <div className="radio">
          <label>
            <input type="radio" value="meuble" />
            Meuble
          </label>
        </div>
      </form>
...
<button type="submit" class="btn btn-primary pull-right" style={{background: '#87bfd4', color: '#000000', marginTop : 170}}>Enregistrer</button>  
